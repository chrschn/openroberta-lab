...
Blockly.Msg.ORA_USER_CREATE_SUCCESS_ACTIVATION_MAIL_FAIL = "Вашата сметка е креирана, но е-поштата за активација не можеше да се испрати. Во Најава → Промени можете да ја ажурирате адресата за е-пошта или повторно да ја испратите врската за активација.";
...
Blockly.Msg.SENSOR_GESTURE_BACK_GETSAMPLE_TOOLTIP = "Враќа »точно« ако положбата е на задната страна.";
...
Blockly.Msg.SENSOR_GESTURE_DOWN_GETSAMPLE_TOOLTIP = "Враќа »точно« ако положбата е наопаку.";
Blockly.Msg.SENSOR_GESTURE_FACE_DOWN = "at the front side";
Blockly.Msg.SENSOR_GESTURE_FACE_DOWN_GETSAMPLE_TOOLTIP = "Враќа »точно« ако предната страна е свртена надолу.";
Blockly.Msg.SENSOR_GESTURE_FACE_UP = "at the back";
Blockly.Msg.SENSOR_GESTURE_FACE_UP_GETSAMPLE_TOOLTIP = "Враќа »точно« ако предната страна е свртена нагоре.";
Blockly.Msg.SENSOR_GESTURE_FREEFALL = "freely falling";
Blockly.Msg.SENSOR_GESTURE_FREEFALL_GETSAMPLE_TOOLTIP = "Враќа »точно« ако уредот е во слободен пад.";
Blockly.Msg.SENSOR_GESTURE_FRONT_GETSAMPLE_TOOLTIP = "Враќа »точно« ако положбата е на предната страна.";
Blockly.Msg.SENSOR_GESTURE_GESTURE_GETSAMPLE_TOOLTIP = "Gets the current gesture reading of the sensor [1-6].";  // untranslated
Blockly.Msg.SENSOR_GESTURE_LEFT_GETSAMPLE_TOOLTIP = "Враќа »точно« ако положбата е навалена налево.";
...
Blockly.Msg.SENSOR_GESTURE_RIGHT_GETSAMPLE_TOOLTIP = "Враќа »точно« ако положбата е навалена надесно.";
Blockly.Msg.SENSOR_GESTURE_SHAKE = "shaking";
Blockly.Msg.SENSOR_GESTURE_SHAKE_GETSAMPLE_TOOLTIP = "Враќа »точно« ако уредот се протресе.";
Blockly.Msg.SENSOR_GESTURE_TAPPED_GETSAMPLE_TOOLTIP = "Враќа »точно« ако уредот е потчукнат.";
...
Blockly.Msg.SENSOR_GESTURE_UP_GETSAMPLE_TOOLTIP = "Враќа »точно« ако положбата е исправена.";
