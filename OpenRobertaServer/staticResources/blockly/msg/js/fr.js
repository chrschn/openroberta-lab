...
Blockly.Msg.LED_TOOLTIP_NIBO = "Allume la LED. Attention c'est très lumineux !";
...
Blockly.Msg.ORA_USER_CREATE_SUCCESS_ACTIVATION_MAIL_FAIL = "Votre compte a été créé, mais l’e-mail d’activation n’a pas pu être envoyé. Sous Connexion → Modifier, vous pouvez mettre à jour votre adresse e-mail ou renvoyer le lien d’activation.";
...
Blockly.Msg.RGB_LED_OFF_TOOLTIP = "Éteint la LED";
Blockly.Msg.RGB_LED_ON_TOOLTIP = "Allume la LED et change sa couleur";
...
Blockly.Msg.SENSOR_GESTURE_BACK_GETSAMPLE_TOOLTIP = "Renvoie »vrai« si la position repose sur la face arrière.";
...
Blockly.Msg.SENSOR_GESTURE_DOWN_GETSAMPLE_TOOLTIP = "Renvoie »vrai« si la position est renversée.";
Blockly.Msg.SENSOR_GESTURE_FACE_DOWN = "at the front side";  // untranslated
Blockly.Msg.SENSOR_GESTURE_FACE_DOWN_GETSAMPLE_TOOLTIP = "Renvoie »vrai« si la face est orientée vers le bas.";
Blockly.Msg.SENSOR_GESTURE_FACE_UP = "at the back";  // untranslated
Blockly.Msg.SENSOR_GESTURE_FACE_UP_GETSAMPLE_TOOLTIP = "Renvoie »vrai« si la face est orientée vers le haut.";
Blockly.Msg.SENSOR_GESTURE_FREEFALL = "freely falling";  // untranslated
Blockly.Msg.SENSOR_GESTURE_FREEFALL_GETSAMPLE_TOOLTIP = "Renvoie »vrai« si l'appareil est en chute libre.";
Blockly.Msg.SENSOR_GESTURE_FRONT_GETSAMPLE_TOOLTIP = "Renvoie »vrai« si la position repose sur la face avant.";
Blockly.Msg.SENSOR_GESTURE_GESTURE_GETSAMPLE_TOOLTIP = "Gets the current gesture reading of the sensor [1-6].";  // untranslated
Blockly.Msg.SENSOR_GESTURE_LEFT_GETSAMPLE_TOOLTIP = "Renvoie »vrai« si la position est inclinée vers la gauche.";
...
Blockly.Msg.SENSOR_GESTURE_RIGHT_GETSAMPLE_TOOLTIP = "Renvoie »vrai« si la position est inclinée vers la droite.";
Blockly.Msg.SENSOR_GESTURE_SHAKE = "shaking";  // untranslated
Blockly.Msg.SENSOR_GESTURE_SHAKE_GETSAMPLE_TOOLTIP = "Renvoie »vrai« si l'appareil est secoué.";
Blockly.Msg.SENSOR_GESTURE_TAPPED_GETSAMPLE_TOOLTIP = "Renvoie »vrai« si un tapotement est détecté.";
...
Blockly.Msg.SENSOR_GESTURE_UP_GETSAMPLE_TOOLTIP = "Renvoie »vrai« si la position est droite.";
