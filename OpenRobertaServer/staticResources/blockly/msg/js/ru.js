...
Blockly.Msg.LED_OFF_TOOLTIP_NAO = "Выключить выбранный светодиод.";
...
Blockly.Msg.LED_SET_INTENSITY_TOOLTIP = "Set the intensity of selected LED(s) in a range from 0 to 100. Ears, head and chest LEDs are available";  // untranslated
...
Blockly.Msg.LED_TOOLTIP_NIBO = "Включает светодиот. Осторожно, он очень яркий!";
...
Blockly.Msg.MOTOR_REAR_LEFT = "rear left";  // untranslated
Blockly.Msg.MOTOR_REAR_RIGHT = "rear right";  // untranslated
...
Blockly.Msg.MOTOR_TOOLTIP = "Represents a motor.";  // untranslated
...
Blockly.Msg.NN_EXPLORE_RESET_VALUES = "Reset neuron output values";  // untranslated
Blockly.Msg.NN_EXPLORE_RUN_FULL = "Run forward propagation for the whole network";  // untranslated
Blockly.Msg.NN_EXPLORE_RUN_LAYER = "Run forward propagation layer by layer";  // untranslated
Blockly.Msg.NN_EXPLORE_RUN_NEURON = "Run forward propagation neuron by neuron";  // untranslated
Blockly.Msg.NN_EXPLORE_SHOW_ALL = "show all";  // untranslated
Blockly.Msg.NN_EXPLORE_SHOW_NEXT_NEURON = "next neuron";  // untranslated
Blockly.Msg.NN_FOCUS_OPTION = "show and change";  // untranslated
Blockly.Msg.NN_GENERATE_VALUES_FROM = "from";  // untranslated
Blockly.Msg.NN_GENERATE_VALUES_TO = "to";  // untranslated
...
Blockly.Msg.NN_INVALID_INPUT_NEURON_VALUE = "invalid input; please enter only numeric values";  // untranslated
...
Blockly.Msg.NN_INVALID_TEST_TRAIN_DATA = "Invalid test/training data uploaded";  // untranslated
Blockly.Msg.NN_LEARNING_RATE = "learning rate";  // untranslated
Blockly.Msg.NN_LEARN_EPOCH = "Train the network for one epoch";  // untranslated
Blockly.Msg.NN_LEARN_EPOCHS_TO_TRAIN = "epochs to train";  // untranslated
Blockly.Msg.NN_LEARN_EPOCH_NUMBER = "Epoch #";  // untranslated
Blockly.Msg.NN_LEARN_ITERATION_NUMBER = "test data line #";  // untranslated
Blockly.Msg.NN_LEARN_ONE_LINE = "Train the network with one line of the training data";  // untranslated
Blockly.Msg.NN_LEARN_RESET_VALUES = "Reset weights and biases to original values";  // untranslated
Blockly.Msg.NN_LEARN_RUN = "Start/pause training for the network";  // untranslated
Blockly.Msg.NN_LEARN_TRAINING_LOSS = "Training loss";  // untranslated
Blockly.Msg.NN_LEARN_UPLOAD = "Upload test/training data file (semicolon separated data accepted)";  // untranslated
Blockly.Msg.NN_LEARN_UPLOAD_POPUP = "Open a popup window and enter input-output test/training data";  // untranslated
Blockly.Msg.NN_OUTPUT_NEURON = "output neuron";  // untranslated
Blockly.Msg.NN_RANDOM_WEIGHTS_BIASES = "random vals";  // untranslated
...
Blockly.Msg.NN_SHAPE = "shape";  // untranslated
Blockly.Msg.NN_SHOW_ALL = "show all";  // untranslated
...
Blockly.Msg.ORA_USER_CREATE_SUCCESS_ACTIVATION_MAIL_FAIL = "Ваша учётная запись создана, но письмо для активации не удалось отправить. В разделе Вход → Изменить можно обновить адрес электронной почты или повторно отправить ссылку активации.";
...
Blockly.Msg.PHOTOTRANSISTOR_TOOLTIP = "represents a phototransistor sensor that detects light.";  // untranslated
...
Blockly.Msg.RGB_LED_OFF_TOOLTIP = "Выключает светодиод.";
Blockly.Msg.RGB_LED_ON_TOOLTIP = "Включает светодиот и меняет цвет.";
Blockly.Msg.RGB_LED_ON_TOOLTIP_CALLIOPE = "Turns the RGB LED on and changes the color. Attention: calli:Bot only supports 7 different colors, the nearest will be chosen.";  // untranslated
Blockly.Msg.RGB_LED_ON_TOOLTIP_EDISON = "Turns the LED on.";  // untranslated
Blockly.Msg.RGB_LED_TOOLTIP = "Turns the RGB LED on and changes the color.";  // untranslated
...
Blockly.Msg.SENSOR_BALLDETECTOR = "ball detector";  // untranslated
Blockly.Msg.SENSOR_BALLDETECTOR_BALL_GETSAMPLE_TOOLTIP = "Returns a list [x, y, diameter] representing information about a ball matching the color set in the configuration. If no ball is found, returns a list of [-1, -1, -1].";  // untranslated
...
Blockly.Msg.SENSOR_COLORDETECTOR = "colour detector";  // untranslated
Blockly.Msg.SENSOR_COLORDETECTOR_COLOUR_GETSAMPLE_TOOLTIP = "Returns the average color of the specified camera area (configuration).";  // untranslated
...
Blockly.Msg.SENSOR_ENVIRONMENTAL_CALIBRATION_TOOLTIP = "Calibrates the environmental sensor. This takes several minutes.";  // untranslated
...
Blockly.Msg.SENSOR_GESTURE_BACK_GETSAMPLE_TOOLTIP = "Возвращает »истина«, если устройство лежит на задней стороне.";
Blockly.Msg.SENSOR_GESTURE_COLOUR_GETSAMPLE_TOOLTIP = "Gets the current reading from the colour reading of the sensor.";  // untranslated
Blockly.Msg.SENSOR_GESTURE_DOWN = "upside down";  // untranslated
Blockly.Msg.SENSOR_GESTURE_DOWN_GETSAMPLE_TOOLTIP = "Возвращает »истина«, если устройство перевёрнуто вверх дном.";
Blockly.Msg.SENSOR_GESTURE_FACE_DOWN = "at the front side";  // untranslated
Blockly.Msg.SENSOR_GESTURE_FACE_DOWN_GETSAMPLE_TOOLTIP = "Возвращает »истина«, если передняя сторона направлена вниз.";
Blockly.Msg.SENSOR_GESTURE_FACE_UP = "at the back";  // untranslated
Blockly.Msg.SENSOR_GESTURE_FACE_UP_GETSAMPLE_TOOLTIP = "Возвращает »истина«, если передняя сторона направлена вверх.";
Blockly.Msg.SENSOR_GESTURE_FREEFALL = "freely falling";  // untranslated
Blockly.Msg.SENSOR_GESTURE_FREEFALL_GETSAMPLE_TOOLTIP = "Возвращает »истина«, если устройство находится в свободном падении.";
Blockly.Msg.SENSOR_GESTURE_FRONT_GETSAMPLE_TOOLTIP = "Возвращает »истина«, если устройство лежит на передней стороне.";
Blockly.Msg.SENSOR_GESTURE_GESTURE_GETSAMPLE_TOOLTIP = "Gets the current gesture reading of the sensor [1-6].";  // untranslated
Blockly.Msg.SENSOR_GESTURE_LEFT_GETSAMPLE_TOOLTIP = "Возвращает »истина«, если устройство наклонено влево.";
...
Blockly.Msg.SENSOR_GESTURE_RIGHT_GETSAMPLE_TOOLTIP = "Возвращает »истина«, если устройство наклонено вправо.";
Blockly.Msg.SENSOR_GESTURE_SHAKE = "shaking";  // untranslated
Blockly.Msg.SENSOR_GESTURE_SHAKE_GETSAMPLE_TOOLTIP = "Возвращает »истина«, если устройство встряхивают.";
Blockly.Msg.SENSOR_GESTURE_TAPPED_GETSAMPLE_TOOLTIP = "Возвращает »истина«, если по устройству постучали.";
Blockly.Msg.SENSOR_GESTURE_TOOLTIP = "Находится ли система в выбранном состоянии?";
Blockly.Msg.SENSOR_GESTURE_TXT4 = "RGB gesture sensor";  // untranslated
Blockly.Msg.SENSOR_GESTURE_UP = "upright";  // untranslated
Blockly.Msg.SENSOR_GESTURE_UP_GETSAMPLE_TOOLTIP = "Возвращает »истина«, если устройство находится в вертикальном положении.";
...
Blockly.Msg.SENSOR_IMU = "Inertial measuring unit";  // untranslated
Blockly.Msg.SENSOR_IMU_GETSAMPLE_TOOLTIP = "Gets the current reading from the inertial measurement unit (IMU).";  // untranslated
Blockly.Msg.SENSOR_IMU_TXT4 = "Combi-sensor";  // untranslated
Blockly.Msg.SENSOR_INDUCTIVE = "inductive sensor";  // untranslated
Blockly.Msg.SENSOR_INDUCTIVE_GETSAMPLE_TOOLTIP = "Gets the current reading from the inductive sensor.";  // untranslated
...
Blockly.Msg.SENSOR_LINE_NUMBERLINES_GETSAMPLE_TOOLTIP = "Returns the number of lines detected by the camera (up to 6).";  // untranslated
Blockly.Msg.SENSOR_LINE_TXT4 = "line detector";  // untranslated
...
Blockly.Msg.SENSOR_MOTIONDETECTOR = "motion detector";  // untranslated
Blockly.Msg.SENSOR_MOTIONDETECTOR_MOTION_GETSAMPLE_TOOLTIP = "Returns a boolean (true or false) indicating whether a specified amount of pixel change, as defined by the sensitivity in the configuration, has occurred.";  // untranslated
...
Blockly.Msg.SENSOR_PHOTOTRANSISTOR_GETSAMPLE_TOOLTIP = "Returns True if the phototransistor detects light, otherwise False.";  // untranslated
...
Blockly.Msg.SENSOR_TEMPERATURE_RESISTANCE_GETSAMPLE_TOOLTIP = "Gets the current resistance reading from the temperature sensor in ohms.";  // untranslated
...
Blockly.Msg.SENSOR_TOUCHKEY = "display button";  // untranslated
...
Blockly.Msg.SIM_VALUES_NEURON = "Neuron Values";  // untranslated
...
Blockly.Msg.SIM_VALUES_VARIABLE = "Variable Values";  // untranslated
...
Blockly.Msg.SOUND_AIRPLANE = "airplane";  // untranslated
Blockly.Msg.SOUND_ALARM = "alarm";  // untranslated
...
Blockly.Msg.SOUND_BELL = "bell";  // untranslated
Blockly.Msg.SOUND_BIRTHDAY = "birthday";  // untranslated
Blockly.Msg.SOUND_BLUES = "blues";  // untranslated
Blockly.Msg.SOUND_BRAKING = "braking";  // untranslated
Blockly.Msg.SOUND_CARHORN_LONG = "car horn long";  // untranslated
Blockly.Msg.SOUND_CARHORN_SHORT = "car horn short";  // untranslated
...
Blockly.Msg.SOUND_CRACKLING_WOOD = "crackling wood";  // untranslated
Blockly.Msg.SOUND_DADADADUM = "dadadadum";  // untranslated
Blockly.Msg.SOUND_ENTERTAINER = "entertainer";  // untranslated
Blockly.Msg.SOUND_EXCAVATOR = "excavator";  // untranslated
Blockly.Msg.SOUND_FANTASY = "fantasy";  // untranslated
Blockly.Msg.SOUND_FARM = "farm";  // untranslated
Blockly.Msg.SOUND_FIRE = "fire noises";  // untranslated
Blockly.Msg.SOUND_FIRE_DEPARTMENT = "fire department";  // untranslated
Blockly.Msg.SOUND_FORMULAONE = "Formula 1";  // untranslated
...
Blockly.Msg.SOUND_HELICOPTER = "helicopter";  // untranslated
Blockly.Msg.SOUND_HELLO = "hello";  // untranslated
Blockly.Msg.SOUND_HORN_SHIP = "ships horn";  // untranslated
Blockly.Msg.SOUND_HYDRAULIC = "hydraulic";  // untranslated
Blockly.Msg.SOUND_JUMP_DOWN = "jump down";  // untranslated
Blockly.Msg.SOUND_JUMP_UP = "jump up";  // untranslated
Blockly.Msg.SOUND_MOTOR_STARTING = "motor starting";  // untranslated
...
Blockly.Msg.SOUND_PROPELLER = "propeller";  // untranslated
Blockly.Msg.SOUND_PUNCHLINE = "punchline";  // untranslated
Blockly.Msg.SOUND_PYTHON = "python";  // untranslated
Blockly.Msg.SOUND_RAISE_HEAD = "raise head";  // untranslated
...
Blockly.Msg.SOUND_ROLLER_COASTER = "roller coaster";  // untranslated
...
Blockly.Msg.SOUND_TILT_HEAD = "tilt head";  // untranslated
...
Blockly.Msg.SOUND_TRACTOR = "tractor";  // untranslated
Blockly.Msg.SOUND_TRUCK = "truck";  // untranslated
...
Blockly.Msg.SOUND_WINK = "wink";  // untranslated
...
Blockly.Msg.START_OPTIONS = "More options";  // untranslated
...
Blockly.Msg.TURN_BRICKLIGHT = "turn brick light";  // untranslated
Blockly.Msg.TURN_RGBLED = "turn RGB LED";  // untranslated
