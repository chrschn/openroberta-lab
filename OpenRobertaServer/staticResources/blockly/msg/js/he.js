...
Blockly.Msg.ORA_USER_CREATE_SUCCESS_ACTIVATION_MAIL_FAIL = "החשבון שלך נוצר, אך לא ניתן היה לשלוח את הודעת ההפעלה. תחת כניסה → שינוי ניתן לעדכן את כתובת הדוא״ל או לשלוח מחדש את קישור ההפעלה.";
...
Blockly.Msg.SENSOR_GESTURE_BACK_GETSAMPLE_TOOLTIP = "מחזיר »אמת« אם המצב הוא על הצד האחורי.";
...
Blockly.Msg.SENSOR_GESTURE_DOWN_GETSAMPLE_TOOLTIP = "מחזיר »אמת« אם המצב הפוך.";
Blockly.Msg.SENSOR_GESTURE_FACE_DOWN = "at the front side";
Blockly.Msg.SENSOR_GESTURE_FACE_DOWN_GETSAMPLE_TOOLTIP = "מחזיר »אמת« אם הצד הקדמי פונה כלפי מטה.";
Blockly.Msg.SENSOR_GESTURE_FACE_UP = "at the back";
Blockly.Msg.SENSOR_GESTURE_FACE_UP_GETSAMPLE_TOOLTIP = "מחזיר »אמת« אם הצד הקדמי פונה כלפי מעלה.";
Blockly.Msg.SENSOR_GESTURE_FREEFALL = "freely falling";
Blockly.Msg.SENSOR_GESTURE_FREEFALL_GETSAMPLE_TOOLTIP = "מחזיר »אמת« אם ההתקן נמצא בנפילה חופשית.";
Blockly.Msg.SENSOR_GESTURE_FRONT_GETSAMPLE_TOOLTIP = "מחזיר »אמת« אם המצב הוא על הצד הקדמי.";
Blockly.Msg.SENSOR_GESTURE_GESTURE_GETSAMPLE_TOOLTIP = "Gets the current gesture reading of the sensor [1-6].";  // untranslated
Blockly.Msg.SENSOR_GESTURE_LEFT_GETSAMPLE_TOOLTIP = "מחזיר »אמת« אם המצב מוטה שמאלה.";
...
Blockly.Msg.SENSOR_GESTURE_RIGHT_GETSAMPLE_TOOLTIP = "מחזיר »אמת« אם המצב מוטה ימינה.";
Blockly.Msg.SENSOR_GESTURE_SHAKE = "shaking";
Blockly.Msg.SENSOR_GESTURE_SHAKE_GETSAMPLE_TOOLTIP = "מחזיר »אמת« אם מנערים את ההתקן.";
Blockly.Msg.SENSOR_GESTURE_TAPPED_GETSAMPLE_TOOLTIP = "מחזיר »אמת« אם מקישים על ההתקן.";
...
Blockly.Msg.SENSOR_GESTURE_UP_GETSAMPLE_TOOLTIP = "מחזיר »אמת« אם המצב זקוף.";
