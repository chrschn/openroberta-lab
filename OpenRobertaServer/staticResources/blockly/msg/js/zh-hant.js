...
Blockly.Msg.LED_OFF_TOOLTIP_NAO = "關閉選定的LED燈。";
...
Blockly.Msg.LED_SET_INTENSITY_TOOLTIP = "將所選LED燈的強度設置為從0到100的範圍。可提供耳、頭和胸LED燈";
...
Blockly.Msg.LED_TOOLTIP_NIBO = "打開LED燈。小心點, 很亮!";
Blockly.Msg.LEFT = "左邊";
...
Blockly.Msg.ORA_USER_CREATE_SUCCESS_ACTIVATION_MAIL_FAIL = "您的帳戶已建立，但無法傳送啟用電子郵件。您可以在「登入 → 變更」中更新電子郵件地址或重新傳送啟用連結。";
...
Blockly.Msg.RGB_LED_OFF_TOOLTIP = "關閉LED燈。";
Blockly.Msg.RGB_LED_ON_TOOLTIP = "打開LED燈並更改顏色。";
...
Blockly.Msg.SENSOR_GESTURE_BACK_GETSAMPLE_TOOLTIP = "如果姿態位於後側，則傳回「真」。";
...
Blockly.Msg.SENSOR_GESTURE_FRONT_GETSAMPLE_TOOLTIP = "如果姿態位於前側，則傳回「真」。";
Blockly.Msg.SENSOR_GESTURE_GESTURE_GETSAMPLE_TOOLTIP = "Gets the current gesture reading of the sensor [1-6].";  // untranslated
Blockly.Msg.SENSOR_GESTURE_LEFT_GETSAMPLE_TOOLTIP = "如果姿態向左傾斜，則傳回「真」。";
...
Blockly.Msg.SENSOR_GESTURE_RIGHT_GETSAMPLE_TOOLTIP = "如果姿態向右傾斜，則傳回「真」。";
Blockly.Msg.SENSOR_GESTURE_SHAKE = "shaking";  // untranslated
Blockly.Msg.SENSOR_GESTURE_SHAKE_GETSAMPLE_TOOLTIP = "如果震動, 返回»true«。";
Blockly.Msg.SENSOR_GESTURE_TAPPED_GETSAMPLE_TOOLTIP = "如果裝置被輕敲，則傳回「真」。";
