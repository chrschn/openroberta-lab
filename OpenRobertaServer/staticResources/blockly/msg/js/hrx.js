...
Blockly.Msg.BRICKLIGHT_ON_TOOLTIP = "Turns the bricklight on and changes the color.";  // untranslated
...
Blockly.Msg.ORA_USER_CREATE_SUCCESS_ACTIVATION_MAIL_FAIL = "Your account was created, but the activation email could not be sent. You can update your email or resend the activation link under Login → Change.";  // untranslated
...
Blockly.Msg.SENSOR_GESTURE_BACK_GETSAMPLE_TOOLTIP = "Returns »true« if the posture is on the back side.";  // untranslated
...
Blockly.Msg.SENSOR_GESTURE_FRONT_GETSAMPLE_TOOLTIP = "Returns »true« if the posture is on the front side.";  // untranslated
Blockly.Msg.SENSOR_GESTURE_GESTURE_GETSAMPLE_TOOLTIP = "Gets the current gesture reading of the sensor [1-6].";  // untranslated
Blockly.Msg.SENSOR_GESTURE_LEFT_GETSAMPLE_TOOLTIP = "Returns »true« if the posture is tilted to the left.";  // untranslated
...
Blockly.Msg.SENSOR_GESTURE_RIGHT_GETSAMPLE_TOOLTIP = "Returns »true« if the posture is tilted to the right.";  // untranslated
...
Blockly.Msg.SENSOR_GESTURE_TAPPED_GETSAMPLE_TOOLTIP = "Returns »true« if it is tapped.";  // untranslated
